...
class Blip4VideoBaseProcessor(BaseProcessor):
...
@registry.register_processor("blip4_video_train")
class Blip4VideoTrainProcessor(Blip4VideoBaseProcessor):
    def __init__(
        self,
        image_size=384,
        mean=None,
    ...
    def from_config(cls, cfg=None):
        ...
        sample_type = cfg.get("sample_type", "headtail")
...
@registry.register_processor("blip4_video_eval")
class Blip4VideoEvalProcessor(Blip4VideoBaseProcessor):
    def __init__(
        self, 
        image_size=256, 
        mean=None, 
    ...
    def from_config(cls, cfg=None):
        ...
        n_frms = cfg.get("n_frms", MAX_INT)
        sample_type = cfg.get("sample_type", "uniform")
