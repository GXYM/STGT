...
@registry.register_builder("lsmdc_retrieval")
class LSMDCRetrievalBuilder(BaseDatasetBuilder):
    train_dataset_cls = VideoRetrievalDataset
    eval_dataset_cls = VideoRetrievalEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/lsmdc/defaults_ret.yaml"}



@registry.register_builder("msvd_retrieval")
class MSVDRetrievalBuilder(BaseDatasetBuilder):
    train_dataset_cls = VideoRetrievalDataset
    eval_dataset_cls = VideoRetrievalEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/msvd/defaults_ret.yaml"}
