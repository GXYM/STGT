...
def create_cn_clip_vit_h(img_size=224,drop_path_rate=0.4,use_checkpoint=False,precision="fp16"):
    ...
    cached_file = "/apdcephfs_cq2/share_1367250/tianzhili/pretrain_models/clip_cn_vit-h-14.pt"
    state_dict = torch.load(cached_file, map_location="cpu")  
