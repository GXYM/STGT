...
class AlproRetrieval(AlproBase):
    PRETRAINED_MODEL_CONFIG_DICT = {
        "msrvtt": "configs/models/alpro/alpro_retrieval_msrvtt.yaml",
        "didemo": "configs/models/alpro/alpro_retrieval_didemo.yaml",
    }
    ...
    def compute_sim_matrix(self, data_loader, task_cfg):
        ...
        for i, sims in enumerate(
            ...
            embedding_output = torch.cat(
                [(text_feats.to(self.device))[[topk_idx]], video_feats_repeat], dim=1
            )
