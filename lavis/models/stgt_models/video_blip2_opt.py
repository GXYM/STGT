...
from lavis.models.blip4video_models.blip2 import Blip2Base, disabled_train
# from lavis.models.blip2_models.modeling_opt import OPTForCausalLM, OPTConfig
from transformers import AutoTokenizer, OPTForCausalLM, OPTConfig
import transformers


@registry.register_model("blip4video_opt")
class Blip4VideosOPT(Blip2Base):
    """
    BLIP4VIDEO OPT model.
    Supported model types:
        - pretrained_opt2.7b: pretrained model with OPT2.7b
        - msrvtt_qa_opt2.7b: fintuned video VQA model with OPT2.7b
        - msvd_qa_opt2.7b: fintuned video VQA model with OPT2.7b
    Usage:
        >>> from lavis.models import load_model
        >>> model = load_model("blip2_opt", "msrvtt_qa_opt2.7b")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "pretrain_opt2.7b": "configs/models/blip4video/blip4video_opt_pretrain.yaml",
        "msrvtt_qa_opt2.7b": "configs/models/blip4video/blip4video_opt_qa.yaml",
        "msvd_qa_opt2.7b": "configs/models/blip4video/blip4video_opt_qa.yaml",
    }
