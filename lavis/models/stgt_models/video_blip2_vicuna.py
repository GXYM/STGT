...
from lavis.models.blip4video_models.modeling_llama import LlamaForCausalLM

from lavis.common.registry import registry
from lavis.models.blip4video_models.blip2 import Blip2Base, disabled_train

@registry.register_model("blip4video_vicuna_instruct")
class Blip4VideosVicunaInstruct(Blip2Base):
    """
    blip4video Vicuna model.
    Supported model types:
        - vicuna7b
    Usage:
        >>> from lavis.models import load_model
        >>> model = load_model("blip4video_vicuna_instruct", "vicuna7b")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "vicuna7b": "configs/models/blip4video/blip4video_instruct_vicuna.yaml",
    }
